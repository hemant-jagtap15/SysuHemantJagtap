...
const appSetting = {
  databaseURL: "https://leantask-a2cc4-default-rtdb.asia-southeast1.firebasedatabase.app/"
}
...
export default function Story() {
  ...
  // useRef used for closing the drop down for -"What are you looking for section"
  const dropdownRef = useRef(null);
  
  // for showing 
  const handleShare = (item) => {
    const lowercasedItem = item.toLowerCase();
    copy(`${window.location.href}${lowercasedItem}`);
  ...
  // add success toast on successfull publish of Story
  ...
  // useeffect used for closing the drop down for -"What are you looking for section"
  useEffect(() => {
  ...
  // handle route for navigation of catgories
        ...
        return (
          <div className='item-section' key={item[2]} style={isRevealed ? revealMain : {}}>
            <div className='item-category'>
              <div className='forh3'>
                <h3 onClick={() => handleRoute(item[0])}>{item[0]}</h3>
                {/* star and share icon creation */}
                <div className='starAndShare'>
                  <div onClick={() => setShowStar(!showStar)}>
                  {showStar ? (
                      <FaRegStar style={{ color: 'transparent', fontSize: 20, fill: 'goldenrod' }} />
                    ) : (
                      <CiStar style={{ fontSize: 20 }} />
                    )}
                  </div>
                  <div onClick={() => handleShare(item[0])}>
                    <FaShare style={{ fontSize: 20 , cursor: 'pointer'}} />
                  </div>
                </div>
              </div>
      ...
      <div className='story-section'>
        ...
        <section className='section-2'>
          ...
          <div className='section-2-head'>
            {/*Changed - "Read their stories" to Read stories on <Category Name> */}
            <h1>Read stories</h1>
